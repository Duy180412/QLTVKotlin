package com.example.qltvkotlin.presentation.feature.docgiainfo
...
class InfoDocGiaFragment : NavigationFragment(R.layout.fragment_info_doc_gia) {
    ...
    override fun clickEditAndSave(it: View) {
        ...
        if (viewmodel.checkHasChange() || !viewmodel.checkValidator()) {
            dialogProvider.selectYesNo("Sửa Sách ?",
                { viewmodel.update() },
                { viewmodel.tatSuaDocGia() })
        }
    }
